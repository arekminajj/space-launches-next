...
export async function getStaticProps(context) {
  const res = await fetch(process.env.BASE_URL + '/api/launch/previous');
...
export default function Previous({ launches }) {
  return (
    <Container>
      <Head>
        <title>PeopleInSpace - Previous Launches</title>
      </Head>
      <div style={{ height: 15 }}></div>
      <h1 style={{ textAlign: "center" }}>Previous Launches</h1>
      <Row>
